<template>
    <div>
    	<head-top signin-up='msite' goBack="true" head-title="员工管理">
        ...
        <div class="cneter-con paddingTop">
            ...
            <div class="worker-list list" v-for="list in workerList" @click="$router.push({name:'workerOption',query:list})">
                <span>{{list.employeeName}}</span>
                <p>所属门店：<em>{{list.storeName}}</em></p>
                <p>最后登陆时间：<em>{{list.storeName}}</em></p>
